...
public class DemoSecurityConfig {
    ...
    // this creates an in-memory user store that spring security uses for authentication
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests(configurer ->
                ...
                form.loginPage("/showMyLoginPage").loginProcessingUrl("/authenticateTheUser").permitAll()).logout(logout ->
